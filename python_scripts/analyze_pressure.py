...
data = np.loadtxt('density_300K.xvg', comments=['@', '#'])
...
plt.title('Density Profile of the Water Slab (300K)', fontsize=14)
...
plt.savefig('slab_profile_300K.png', dpi=300)
print("Plot saved as 'slab_profile_300K.png'")
